...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: ' Garamond'">Div Shopify</a>
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#mynavbar">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="nav navbar-nav">
                       <li class="nav-item"><a href="products.php#watch" >Watches</a></li>
                       <li class="nav-item"><a href="products.php#shirt" >T-Shirts</a></li>
                       <li class="nav-item"><a href="products.php#shoes" >Shoes</a></li>
                       <li class="nav-item"><a href="products.php#headphones" >Headphones/Speakers</a></li>
